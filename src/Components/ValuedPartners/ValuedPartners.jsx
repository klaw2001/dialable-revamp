    ...
    <div className="p-10 flex items-center flex-col">
      ...
      <div className="mt-6 lg:mt-12">
        <div className="flex lg:justify-center items-center flex-wrap  gap-2">
          <div className="partner-bg grow flex justify-center bg-[#F4EBFF] py-4 px-12 w-[45%] lg:w-[30vw]">
        ...
        {/* <div className="flex justify-center items-center mt-2 gap-2">
          <div className="partner-bg grow flex justify-center bg-[#F4EBFF] py-4 px-12 w-[30vw]">
            <div className="w-[8vw]">
              <Image src={relume} alt="relume" className="object-cover" />
            </div>
          </div>
      ...
      <button className="text-black mt-8  montserrat shadow-xl font-bold lg:h-[3vw] lg:ml-5  btn text-[3vw] md:text-[2vw] lg:text-[1vw] py-2 px-6 leading-none border-[2px] border-black ">
        Know More
      </button>
    </div>
  );
