...
const PersonalInfo = () => {
  return (
    <div className="grow-[.8] md:pl-8 md:border-l border-[#00000075]">
      ...
      <p className="text-[4vw] md:text-[1.5vw] lg:text-[0.8vw] montserrat font-semibold">
        Manage/Edit your personal information, where you can be contacted.
      </p>

      <div className="my-8 md:my-16">
        <form>
          <div className="flex gap-4 my-4 md:my-8 flex-wrap">
            <div className="bg-white py-2 grow rounded-md shadow-md px-4">
              <div className="flex montserrat text-[4.5vw] md:text-[2vw] lg:text-[1vw] font-semibold items-center justify-between">
                <label htmlFor="name">Name</label>
                <FaRegUser color="#FF6004" />
              </div>
              <input
                type="text"
                className="text-[4vw] md:text-[1.4vw] lg:text-[0.86vw] w-full montserrat"
          ...
          <div className="flex gap-4 my-4 md:my-8 flex-wrap">
            <div className="bg-white py-2 grow md:grow-[.37] rounded-md shadow-md px-4">
              <div className="flex montserrat text-[4.5vw] md:text-[2vw] lg:text-[1vw] font-semibold items-center justify-between">
          ...
          <button
            className="btn px-3 mt-8 mb-12 text-white shadow-md montserrat font-medium bg-[#781393] text-[3vw] text-[4.5vw] md:text-[2vw] lg:text-[1vw]"
            type="submit"
          >
            Save Changes
          </button>
