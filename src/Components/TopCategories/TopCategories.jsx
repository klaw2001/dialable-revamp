...
const TopCategories = () => {
  return (
    <div className="flex  items-center overflow-hidden relative p-6 lg:px-24 justify-center z-[3] py-32 ">
      <div className="w-[90%] grow lg:grow-[.7] xl:grow-[.4]">
        ...
        <div>
          ...
          <div className="grid grid-cols-5 items-center relative md:items-start gap-8 md:gap-2 lg:gap-24 lg:justify-center mt-16 flex-wrap ">
            {categories.map((category, i) => (
              <div key={i} className="w-max">
                <div className="image_wrapper w-[80px]  md:w-[175px]">
                  <Image
                    src={category.img}
                    alt={category.title}
                    loading="eager"
