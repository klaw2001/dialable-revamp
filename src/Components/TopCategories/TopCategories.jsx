  ...
  return (
    <div className="flex  items-center overflow-hidden relative p-10 lg:p-28 z-[3]">
      <div className="w-[90%] grow lg:grow-[.7] xl:grow-[.4]">
        ...
        <div>
          <div className="flex items-center relative justify-center lg:justify-between gap-8 lg:gap-16 mt-16 flex-wrap ">
            {categories.map((category, i) => (
              <div key={i} className="flex flex-col items-center">
                <div className="image_wrapper w-[30vw] lg:w-[10vw]">
                  <Image
                    src={category.img}
                    alt={category.title}
                ...
                <p className="text-center montserrat text-[3vw] lg:text-[1vw] font-bold">
                  {category.title}
                </p>
              </div>
            ))}
