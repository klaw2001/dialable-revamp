        ...
        <div>
          <div className="flex items-center relative justify-center md:justify-start md:items-start gap-8 md:gap-2 lg:gap-12 lg:justify-start mt-16 flex-wrap ">
            ...
            <div className="flex fixed right-[-3%] md:right-[-3.5%] z-[20] top-[80%] gap-4 rotate-[-90deg] w-[10%] ">
              ...
              <Link
                href="#"
                className="text-white active:scale-[.95] transition-all duration-[.5s] box-shadow-2 bg-[#FF6004] rounded-lg md:rounded-xl text-[0.6rem] md:text-[1rem] lg:text-[1.3vw] font-semibold montserrat leading-none px-[1.35rem] py-4 lg:py-6"
              >
                Free&nbsp;Listing
              </Link>
            </div>
