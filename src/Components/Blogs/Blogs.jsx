...
const Blogs = () => {
  ...
  return (
    <div>
      ...
      <p className="roboto text-[3vw] md:text-[2vw] lg:text-[0.8vw]">Your Best Practices Guide for all your local services needs</p>
      <div className="my-10 ">
        {blogs.map((blog, index) => (
          <div key={index} className="blog shadow-lg lg:shadow-none my-8  flex flex-col gap-3 md:gap-3 md:flex-row items-center">
            ...
            <div className="info flex flex-col p-4 md:p-2 lg:p-0 gap-1 bg-white">
              <div className="flex items-center  gap-8">
                <div className="tag text-[2.5vw] md:text-[1.9vw] lg:text-[.7vw] text-black montserrat font-semibold ">
                  {blog.cat}
                </div>
