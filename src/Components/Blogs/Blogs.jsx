        ...
        {blogs.map((blog, index) => (
          <div key={index} className="blog shadow-lg lg:shadow-none my-8  flex flex-col gap-3 lg:gap-0 lg:flex-row">
            ...
            <div className="info flex flex-col p-4 lg:p-0 gap-1 bg-white">
              ...
              <h1 className="text-black font-semibold text-[4.8vw] mt-2 lg:text-[1.3vw] montserrat">
                {blog.title}
              </h1>
              <p className="text-black font-normal text-[4vw] lg:text-[1vw] roboto">
                {blog.desc}
              </p>
              <button className="text-black font-medium flex items-center montserrat text-[4.2vw] lg:text-[1vw]">
                Read More
