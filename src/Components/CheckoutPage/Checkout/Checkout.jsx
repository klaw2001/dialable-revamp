...
const Checkout = () => {
  return (
    <div className="py-10 px-4 lg:p-24 lg:mb-8 relative overflow-x-clip">
      <div className="breadcrumb mt-0 lg:mt-10 text-black text-[3vw] md:text-[2vw] lg:text-[1.1vw] font-medium">
      ...
      <div className="flex gap-3 md:gap-6 flex-col lg:flex-row montserrat">
        <div className="w-full lg:w-1/2">
          <div className="pb-8 border-b-2 border-black">
            <div className="form montserrat">
              <form>
                <div className="contact flex flex-col gap-3 md:gap-5">
                  <p className="font-bold text-black text-[3vw] md:text-[2vw] lg:text-[1.05vw]">
                    Contact Information
                  </p>
                ...
                <div className="address flex flex-col gap-5 mt-12">
                  ...
                  <div className=" flex items-center gap-1">
                    ...
                    <label htmlFor="save" className="px-2 text-xs">Save Address for Future Orders</label>
                  </div>
                </div>
              </form>
            </div>
        ...
        <div className="w-full lg:w-1/2">
          <div className="montserrat border-2 py-2 px-4 lg:py-8 lg:px-8 bg-[#F4EBFF]  border-[#781393]">
            ...
            <div>
              ...
              <button className="px-4 py-4 mt-6 mb-6 lg:mb-16 w-full bg-[#781393] text-white font-medium active:scale-[.99] transition-all duration-100">
                Proceed to Payment
              </button>
            </div>
          </div>
