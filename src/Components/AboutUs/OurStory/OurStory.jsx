...
const OurStory = () => {
  return (
    <div className="flex flex-col lg:flex-row gap-10 p-10 md:px-6 overflow-x-clip  lg:py-14 lg:px-20">
      <div className="w-full lg:w-1/2 my-8 lg:my-16 Inter">
        ...
        <h1 className="text-black tracking-tight Sans capitalize text-[5vw] md:text-[3.5vw] lg:text-[2.7vw] mb-3 font-bold">
          Who We Are
        </h1>
        <div>
          <p className="font-medium my-6 text-[3.2vw] md:text-[2.2vw] lg:text-[1.2vw] text-black ">
      ...
      <div className="w-full lg:w-1/2 relative">
        ...
        />
        <div className="flex absolute right-[-15%] md:right-[-6%] lg:right-[-10.5%]  top-[100%] gap-4 rotate-[-90deg] w-[10%] ">
          <Link
            href="#"
