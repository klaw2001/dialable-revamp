    ...
    >
      <div className="p-10 lg:p-20 flex flex-col lg:flex-row justify-between">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <div>
            <div className="flex items-center  my-10 gap-20 lg:gap-40 Inter">
              <div className="w-[20vw] lg:w-[6vw]">
                <h1 className="text-[#781393] text-[5.5vw] lg:text-[2.5vw] font-bold mb-1">
                  {countOn && <CountUp start={0} end={2015} duration={5} />}
                </h1>
                <p className="text-[3vw] lg:text-[.9vw] font normal">Founded</p>
              </div>
              <div className="w-[20vw] lg:w-[6vw]">
                <h1 className="text-[#781393] text-[5.5vw] lg:text-[2.5vw] font-bold mb-1">
                  ${countOn && <CountUp start={0} end={20} />}m
                </h1>
                <p className="text-[3vw] lg:text-[.9vw] font normal">Product Sales</p>
              </div>
            </div>
            <div className="flex items-center  my-10 gap-20 lg:gap-40 Inter">
              <div className="w-[20vw] lg:w-[6vw]">
                ...
                <p className="text-[3vw] lg:text-[.9vw] font normal">Employees</p>
              </div>
              <div className="w-[20vw] lg:w-[6vw]">
                <h1 className="text-[#781393] text-[5.5vw] lg:text-[2.5vw] font-bold mb-1">
                ...
                <p className="text-[3vw] lg:text-[.9vw] font normal">Customers</p>
              </div>
            </div>
          </div>
        </div>
