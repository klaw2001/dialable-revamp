    ...
    <div className=" product  relative" style={containerStyle}>
      ...
      >
        ...
        <div className="border-t absolute w-full bottom-0 mt-12 bg-white border-black flex items-center justify-between p-4">
            <button className="text-black text-[3vw] lg:text-[1vw] font-medium">Clear all</button>
            <button className="text-white text-[3vw] lg:text-[1vw] font-medium btn py-3 px-6 bg-[#781393]">Apply</button>
        </div>
      </Drawer>
      <div className="flex p-10 lg:py-10 lg:px-20 items-center gap-1 lg:gap-[2vw] flex-wrap">
        {marketData.slice(0, visibleItem).map((product, i) => (
          <div key={i} className=" product-card border grow lg:grow-0 flex-auto w-[45%] lg:w-[27vw] py-3 px-2">
            <div className="py-2 px-3 bg-[#F4F4F4] w-20 lg:w-24 flex  font-medium items-center gap-2 text-black Inter text-[2vw] lg:text-[1vw]">
            ...
            <div className="product-info mt-3 lg:mt-6">
              <div
                className={`flex items-center text-[3vw] lg:text-[1.2vw] font-semibold justify-between`}
              >
                <span
                  className={` ${
                    product.title === "Healthshine Grade 1 Air Mattress Overlay"
                      ? ` text-[2vw] lg:text-[1.1vw]`
                      : `text-[2.2vw] lg:text-[1.2vw]`
              ...
              <span className="text-[1.8vw] lg:text-[.8vw] Inter capitalize font-medium">
                {product.cat}
              </span>
