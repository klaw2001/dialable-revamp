  ...
  const makePayment = async () => {
    ...
    try {
      ...
      const options = {
        ...
        image:
          "http://res.cloudinary.com/dqpj1vyjn/image/upload/v1704696575/jh8xzhfpc4vtgtpfg7fi.jpg",
  ...
  return (
    <div className="py-10 px-4 lg:py-20 lg:px-10 lg:mb-8 relative overflow-x-clip">
      ...
      <div className="flex gap-6 flex-col lg:flex-row montserrat">
                    ...
                    <div className="grow">
                      <div className="flex flex-col md:flex-row justify-between">
                        <div className="flex gap-3">
                          <div className="info ">
                            ...
                            <p className="text-[2.85vw] md:text-[1.5vw] lg:text-[.85vw]">
                              Color: Black
                            </p>
                            <p className="text-[2.85vw] md:text-[1.5vw] lg:text-[.85vw]">
                              Size: 16 inch
                        ...
                        <div className="flex flex-col md:flex-row gap-6 md:gap-10">
                          <div className="flex items-center">
                            {/* Decrement button */}
                            <button
                              className="border border-gray-300 rounded-full w-8 h-8 flex justify-center items-center"
                              onClick={() => handleDecrement(ind)}
                            >
                              -
                            </button>
                            {/* Display quantity */}
                            <p className="border border-gray-300 rounded-full w-8 h-8 flex justify-center items-center">
                              {product.quantity}
                            </p>
                            {/* Increment button */}
                            <button
                      ...
                      <div className="flex justify-between  mt-8 items-center">
                        <div className="buttons flex items-center gap-3 montserrat">
                          <button className="text-[2.85vw] md:text-[1.5vw] lg:text-[.85vw]">
                            Edit
                          </button>
                          <button className="text-[2.85vw] md:text-[1.5vw] lg:text-[.85vw]">
                            Move to Wishlist
        ...
        <div className="w-full lg:w-1/2">
          <div className="montserrat border-2 pt-2 px-4 lg:pt-4 lg:px-6 bg-[#F4EBFF] pb-28 border-[#781393]">
            <div>
              ...
              <button
                className="p-4 w-full bg-[#781393] text-white font-medium btn"
                onClick={makePayment}
              >
                Checkout
              </button>
