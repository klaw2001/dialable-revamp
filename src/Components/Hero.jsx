...
const Hero = () => {
  return (
    <div className="md:flex max-w-screen-xl mx-auto justify-between lg:h-[100vh] xl:h-[72vh] items-center gap-10 montserrat block p-6  md:p-0 ">
      <div className="hero-cont  md:w-[45%] mt-8 md:mt-6 lg:mt-0  w-full flex items-start  gap-4 md:gap-5  flex-col  ">
        ...
        <div className="desc Sans w-[75%]">
          <p className="text-[black] font-medium text-lg lg:text-[1vw] leading-[1.45rem] ">
            <span className="text-[2.1vw] font-semibold Sans leading-[2rem]">
              Embrace diversities, celebrating inclusion!
            </span>
            <br />
          </p>
          <p className="text-[0.9vw] mt-3 text-[black] font-semibold poppins">
          An all-inclusive hub of knowledge, fostering a community that values and respects the unique perspectives of every individual. Join us in creating a space where everyone feels welcomed, heard, and empowered.
          </p>
        </div>
        ...
        <div className="mt-2 flex flex-col gap-3 items-start">
          <Link
            href={"#"}
            className="text-black font-medium text-[.8vw] underline poppins"
          >
