  ...
  return (
    <div className="p-10">
      <div className="buttons flex items-center justify-center">
        <button className="montserrat uppercase text-[3vw] md:text-[2vw] lg:text-[1.5vw] btn font-medium py-4 lg:py-6 px-8 lg:px-16 bg-[#781393] text-white rounded-s-xl">
          For &nbsp;Abled
        </button>
        <button className="montserrat uppercase text-[3vw] md:text-[2vw] lg:text-[1.5vw] btn font-medium py-4 lg:py-6 px-4 lg:px-6 bg-[#D9D9D9] text-[#00000080] rounded-e-xl">
          For &nbsp;corporates
        </button>
      </div>
      <div className="block md:flex justify-center my-8 lg:my-16 px-0 lg:px-36">
        <div className="w-full md:w-[50%] rounded-t-lg md:rounded-t-none md:rounded-s-lg border-[1.5px]  border-left overflow-hidden border-[#781393]">
        ...
        <div className="w-full md:w-[50%] bg-[#F4EBFF] py-8 lg:py-16 px-4 lg:px-8 xl:px-12 montserrat capitalize border border-y rounded-b-lg  md:rounded-b-none md:rounded-e-lg border-right border-[#781393]">
          ...
          <div className="flex items-center gap-6 mg:gap-8">
