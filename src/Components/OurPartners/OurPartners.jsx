    ...
    <div className="p-6 lg:p-10">
      <div className="buttons flex items-center justify-center">
        ...
        <button
          ...
          className={`montserrat active:scale-[.97] transition-all duration-75 uppercase text-[3vw] md:text-[0.9vw] lg:text-[0.9vw]  font-medium py-4 lg:py-4 px-4 lg:px-4  ${
      ...
      {activeTab === "abled" ? (
        <div className="block md:flex justify-center my-8 lg:my-16 mx-0 md:mx-16 lg:mx-36 rounded-lg overflow-clip">
          ...
          <div className="  bg-[#F4EBFF] py-8  px-4  xl:px-12 montserrat capitalize overflow-clip">
            ...
            <ul className="my-4 md:mt-8 md:mb-6">
              <li className="flex items-center gap-2 py-2 md:py-2">
                <div className="w-[3vw] md:w-[0.8vw]">
                  <Image
                    src={check}
                    alt="marker"
        ...
        <div className="   py-8  px-4  xl:px-12 montserrat capitalize overflow-clip">
          <h2 className="text-black uppercase Sans font-bold text-[4vw] md:text-[1.5vw]">
            our partners like us
          </h2>
          <ul className="my-4 md:mt-8 md:mb-6">
